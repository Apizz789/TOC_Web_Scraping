...
function CategoryDropdown(props) {
  ...
  return (
    <div class="CategoryCard"  >
      <div class="dropdown-menu" onMouseEnter={(e) => props.toggleHandle(true)} onMouseLeave={(e) =>  props.toggleHandle(false)} onMouseEnter={(e) => showSubToggle(true)} onMouseLeave={(e)=> showSubToggle(false)}>
